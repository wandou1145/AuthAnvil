...
public class AuthGUI {
    ...
    public static void openLogin(Player player, String prefill) {
        ...
        AnvilGUI.Builder builder = new AnvilGUI.Builder()
                .plugin(plugin)
                .title("§6✦ 请输入密码 ✦")
                .itemLeft(createItem(Material.RED_DYE, "§r", "§c点击退出游戏"))
                .itemRight(createItem(Material.LIME_DYE, "§r", "§a点击确认登录"))
        ...
        if (config.isCustomSlotEnabled()) {
            builder.itemOutput(createItem(Material.LIGHT_BLUE_DYE, "§r", config.getCustomSlotLore()));
        } else {
    ...
    public static void openRegisterStep1(Player player) {
        openRegisterStep1(player, null);
    }
    ...
    public static void openRegisterStep1(Player player, String prefill) {
        ...
        AnvilGUI.Builder builder = new AnvilGUI.Builder()
                ...
                .title("§6✦ 设置密码 ✦")
                .itemLeft(createItem(Material.RED_DYE, "§r", "§c点击退出游戏"))
                .itemRight(createItem(Material.LIME_DYE, "§r", "§a点击确认第一步"))
                .onClick((slot, stateSnapshot) -> {
                    if (slot == AnvilGUI.Slot.INPUT_LEFT) {
                        player.kickPlayer("§c你选择了退出游戏");
                        return Collections.emptyList();
    ...
    public static void openRegisterStep2(Player player) {
        openRegisterStep2(player, null);
    }
    ...
    public static void openRegisterStep2(Player player, String prefill) {
        ...
        AnvilGUI.Builder builder = new AnvilGUI.Builder()
                ...
                .title("§6✦ 再次输入密码 ✦")
                .itemLeft(createItem(Material.RED_DYE, "§r", "§c点击退出游戏"))
                .itemRight(createItem(Material.LIME_DYE, "§r", "§a点击完成注册"))
                .onClick((slot, stateSnapshot) -> {
                    if (slot == AnvilGUI.Slot.INPUT_LEFT) {
                        player.kickPlayer("§c你选择了退出游戏");
                        return Collections.emptyList();
